...
4. โหลด `GUIDE.md` ของสกิลนั้น ทำตาม workflow
...
```text
ชื่อสกิล/
  GUIDE.md              ← เริ่มที่นี่ workflow สั้นๆ + เช็คคุณภาพ
  references/
...
**ถ้าคุณเป็นคน:** เปิด `GUIDE.md` ของสกิลไหนก็ได้ ใช้เป็นเช็คลิสต์สั้นๆ ได้เลย
