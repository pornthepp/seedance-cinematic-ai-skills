...
- **สกิล Seedance** ออกแบบเฉพาะสำหรับ Seedance 2.0 — บอกว่าความยาวเท่าไหร่ดีที่สุด, motion แบบไหนทำได้ดี/แย่, กล้องแบบไหนควรหลีกเลี่ยง และมีระบบ "สั่งฉาก ไม่ใช่ตกแต่งคำ" ที่ห้ามใช้คำอวยลอยๆ เช่น "cinematic" หรือ "dramatic" แล้วบังคับให้เขียนคำสั่งกำกับฉากจริงๆ แทน
- **แม่แบบฉากของ Seedance** ครอบคลุมทั้งแอ็กชัน ไล่ล่า สยองขวัญ โรแมนติก บทพูด สินค้า โฆษณาเชิงพาณิชย์ มิวสิควิดีโอพร้อมการซิงค์จังหวะ และงานการศึกษา/อธิบาย
