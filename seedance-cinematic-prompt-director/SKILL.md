...
description:
  Use when creating, rewriting, or reviewing Seedance 2.0 video prompts for
  cinematic scenes, action scenes, realistic acting, camera movement, motion
  continuity, audio-video cues, original characters, anti-slop refinement,
  storyboard sequencing, technical format controls, or Thai-to-English film
  prompt direction.
---
